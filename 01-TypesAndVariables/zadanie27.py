# zad.27. Napisz program, który dla dwóch liczb naturalnych wprowadzonych z klawiatury wyznaczy ich największy wspólny podzielnik.

# NWD - wyznaczanie największego wspólnego dzielnika 
